...
export const listAverageChannelsMetricsByProviderDocs = {
  schema: {
    description: 'Get average metrics for channels by provider and period',
    tags: ['metrics'],
    params: z.object({
      provider_id: z.string().uuid().describe('Must be a valid provider UUID'),
